...
get_channel_stats <- function(channel_id = NULL, mine = NULL, ...) {
  ...
  querylist <- list(part = "statistics,snippet,topicDetails", id = channel_id, mine = mine)
  ...
  cat("Topics", res3$topicCategories, "\n")
...
list_my_channel <- function(...) {
  ...
  querylist <- list(part = "snippet,contentDetails,statistics,topicDetails",
                    mine = "true")
